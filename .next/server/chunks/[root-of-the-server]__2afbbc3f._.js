...
(()=>{
    const e = new Error("Cannot find module '@/Mongo/Model/DataModels/eventOutreach'");
...
async function GET() {
    try {
        ...
        const focusAreas = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Mongo$2f$Model$2f$DataModels$2f$FocusArea$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            isDeleted: false
        });
...
async function POST(req) {
    try {
        ...
        const folderPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", `${event.year}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2afbbc3f._.js.map