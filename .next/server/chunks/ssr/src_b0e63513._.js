...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const resultAction = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Redux$2f$Reducer$2f$authSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])(formData));
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Redux$2f$Reducer$2f$authSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"].fulfilled.match(resultAction)) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(resultAction.payload?.error || 'Login failed');
            }
        } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100 p-4",
...
//# sourceMappingURL=src_b0e63513._.js.map