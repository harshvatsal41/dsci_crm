...
const LoginApi = async (method, body)=>{
    ...
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utilities$2f$FetchWithAuth$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FetchWithAuth"])(url, {
        method: method,
        headers: {
            'Content-Type': 'application/json'
        },
...
"[project]/src/app/administration/register/page.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Register() {
    ...
    const handleRegister = async (e)=>{
        ...
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utilities$2f$ApiManager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RegisterApi"])('POST', formData);
            if (res.ok) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Failed to register. Please check your connection and try again.");
        } finally{
...
//# sourceMappingURL=src_25695375._.js.map