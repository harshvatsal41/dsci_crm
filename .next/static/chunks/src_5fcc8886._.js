...
const FetchWithAuth = async (url, method = "GET", body = null, extraHeaders = {}, suppressToast = false)=>{
    ...
    const token = localStorage.getItem("dsciAuthToken") || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("dsciAuthToken") || "";
...
const LoginApi = async (formData)=>{
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utilities$2f$FetchWithAuth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FetchWithAuth"])("/api/admin/auth/login", "POST", formData);
    return res;
};
_c = LoginApi;
...
function Login() {
    ...
    const handleLogin = async (e)=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utilities$2f$ApiManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoginApi"])(formData);
...
//# sourceMappingURL=src_5fcc8886._.js.map