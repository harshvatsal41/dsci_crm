...
function SpecificEventCard() {
    ...
    const fetchEvent = async ()=>{
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utilities$2f$ApiManager$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EventApi"])(null, "Get", {
            id
        });
        if (!res.ok) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Failed to fetch event');
...
_s(SpecificEventCard, "MIquryJimuPqAXCIkKHTdLt3VUc=", false, function() {
    return [
...
//# sourceMappingURL=_dae852b7._.js.map