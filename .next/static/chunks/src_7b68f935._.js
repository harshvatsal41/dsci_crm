...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const resultAction = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Redux$2f$Reducer$2f$authSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])(formData));
            if (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Redux$2f$Reducer$2f$authSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"].fulfilled.match(resultAction)) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(resultAction.payload?.error || 'Login failed');
            }
        } catch (error) {
...
_s(LoginPage, "NjpvUmkzXetySbTyoNgJUZzJBk4=", false, function() {
    return [
